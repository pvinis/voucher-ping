		...
		<div className="min-h-screen flex flex-col">
			<header className="bg-indigo-600 text-white py-6">
				<div className="container mx-auto px-4">
					...
					<p className="mt-2">
						Get notified when new vouchers become available
					</p>
				</div>
			</header>
					...
					{!subscribed ? (
						<div className="bg-white shadow-md rounded p-6 mb-8">
							...
							<p className="mb-6 text-gray-600">
								We'll send you an email whenever new vouchers
								are available. No spam, just notifications.
							</p>
							<SubscribeForm
						...
						<div className="bg-green-50 border border-green-200 rounded p-6 mb-8">
							...
							<p className="text-green-600">
								We'll send notifications to{" "}
								<strong>{email}</strong> when new vouchers are
								available.
							</p>
						</div>
					)}
			...
			<footer className="bg-gray-100 py-6">
				<div className="container mx-auto px-4 text-center text-gray-500">
					<p>
						© {new Date().getFullYear()} Voucher Ping. All rights
						reserved.
					</p>
